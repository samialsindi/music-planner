      ...
      <body className="antialiased min-h-screen flex">
        <aside className="hidden lg:flex w-64 glass-panel m-4 flex-col p-6 fixed h-[calc(100vh-2rem)] z-50 transition-all">
          ...
          <nav className="flex flex-col gap-4 flex-1">
            ...
            <Link href="/declined" className="text-gray-300 hover:text-white transition-colors flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white/5">
            ...
            <Link href="/hidden" className="text-gray-300 hover:text-white transition-colors flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white/5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/><line x1="3" y1="3" x2="21" y2="21"/></svg>
              Hidden
            </Link>
            <Link href="/settings" className="text-gray-300 hover:text-white transition-colors flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white/5">

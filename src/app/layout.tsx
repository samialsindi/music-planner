      ...
      <body className="antialiased min-h-screen flex">
        <aside className="w-64 glass-panel m-4 flex flex-col p-6 fixed h-[calc(100vh-2rem)] z-10 transition-all">
          ...
          <nav className="flex flex-col gap-4 flex-1">
            <a href="/" className="text-gray-300 hover:text-white transition-colors flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white/5">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>
              Calendar
            </a>
            <a href="/gantt" className="text-gray-300 hover:text-white transition-colors flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white/5">
            ...
            <a href="/projects" className="text-gray-300 hover:text-white transition-colors flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white/5">
